...
import type { Connection, KeyValueStore, RenderModel, Review, ReviewRequest } from './types.ts';
    ...
    return (
        <Fragment>
            ...
            {text ? <Description text={text} /> : (
                <Section>
                    <code>{props.emptyBodyWarning}</code>
                </Section>
            )}
        </Fragment>
    );
...
function Approvals(props: RenderModel) {
    ...
    return (
        <Fragment>
            ...
            <Reviewers slackAccounts={props.slackAccounts} reviewers={approvals} text={`approval${unit(approvals)}`} />
            <Reviewers
                slackAccounts={props.slackAccounts}
