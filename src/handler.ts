...
import { ClosedLog, DeployCompleteLog, EditedLog, ReviewRequestedLog, SubmittedLog } from './logger.tsx';
import type { WebhookPayload } from 'https://esm.sh/@actions/github@5.0.3/lib/interfaces';
import type {
    PullRequestEvent,
    PullRequestReviewEvent,
} from 'https://esm.sh/@octokit/webhooks-types@5.8.0/schema.d.ts';
import type {
    ActionContext,
    EventPayload,
    GitHubUser,
